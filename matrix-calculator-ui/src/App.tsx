...
type VisualizationMatrixSnapshot = { label: string; data: NumericMatrix }
...
type VisualizationStep = {
  ...
  /**
   * @deprecated legacy support for earlier visualization payloads that only shipped matrix snapshots.
   * New code should populate {@link VisualizationStep.entities} instead.
   */
  matrices?: VisualizationMatrixSnapshot[]
          ...
          <div className="visualization-card">
            ...
            <ol className="visualization-steps">
              {visualizationSteps.map((step, index) => {
                const stepEntities =
                  step.entities ??
                  step.matrices?.map<VisualizationEntity>((matrix) => ({
                    type: 'matrix',
                    label: matrix.label,
                    data: matrix.data,
                  })) ??
                  ...
                  <li key={`${step.title}-${index}`} className="visualization-step">
                    ...
                    {stepEntities.length ? (
                      <div className="visualization-entities">
                        {stepEntities.map((entity, entityIndex) => (
